...
CREATE TABLE `Helpers` (
  `id_helper` INTEGER NOT NULL AUTO_INCREMENT DEFAULT NULL,
  `fecha_alta` DATE NOT NULL DEFAULT 'NULL',
  `user_facebook` INTEGER NOT NULL DEFAULT NULL,
  `documento_tipo` TINYINT NULL DEFAULT NULL,
  `documento_nro` TINYINT NULL DEFAULT NULL,
  ...
  `telefono_fijo` INTEGER NULL DEFAULT NULL,
...
CREATE TABLE `Paises` (
  `pais` VARCHAR(45) NULL AUTO_INCREMENT DEFAULT NULL,
  PRIMARY KEY (`pais`)
);
